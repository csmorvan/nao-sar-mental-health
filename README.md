...
# NAO-Based Mental Health Support System
...
## Features
- 4–7–8 guided breathing with synchronized motion and LEDs
- Calm break module with seated posture and background audio
- Positive affirmation delivery
- Speech-driven, event-based interaction flow
...
### **Breathing Module:** [Watch demo](videos/nao_breathing_demo.mp4)  
